 ...
 * The wishlist tab.
 *
 * A tab rather than a pushed screen, matching the app this replaces. It is still
 * reachable from the Profile row as well, which is the only surface that shows
 * the count, and `/saved` redirects here for links and notifications already in
 * the wild.
 *
      ...
      {loading ? (
        ...
        <View className="gap-space-4 px-screen py-space-10 items-center">
          ...
          <Button
            ...
            // THIS tab's route for the home route, leaving a tab bar whose
            // Wishlist entry renders the home screen. This switches tabs.
