  ...
  return (
    <SafeAreaView edges={["top"]} className="bg-background flex-1">
      ...
      <View className="border-hairline border-border bg-card px-screen py-space-3 gap-space-3 flex-row items-center">
        {!unavailable ? (
          <View className="h-control gap-space-2 rounded-pill bg-gray-200 px-space-2 flex-row items-center">
            <Pressable
            ...
            <Text size="sm" weight="semibold" className="min-w-[20px] text-center text-gray-800">
              {quantity}
            </Text>
            <Pressable
