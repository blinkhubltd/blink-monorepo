...
export default function PickerProfileScreen() {
  ...
  const vendorDetails = useQuery(
    ...
    currentUser?.picker_details?.vendor_id
      ? { vendorId: currentUser.picker_details.vendor_id }
      : "skip",
  );
      ...
      >
        ...
        >
          ...
          <MenuItem
            ...
            onPress={
              currentUser?.picker_details?.vendor_id ? () => setShowVendorModal(true) : undefined
            }
          />
